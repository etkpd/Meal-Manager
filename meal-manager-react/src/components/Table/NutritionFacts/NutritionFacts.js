...
import stylesNutritionFacts from './NutritionFacts.module.scss'
      ...
      >
          ...
          >
            <div>
              ...
              <span>{props.serving_qty} {props.serving_unit} ({Math.round(props.serving_weight_grams)}g)</span>
            </div>
          </div>
          <div className={stylesNutritionFacts.calorieInfo}>
            ...
            <div>
              <span>Calories</span>
              <span>{Math.round(props.nf_calories)}</span>
            </div>
          </div>
          <div 
